...
let array=[]
let str1 = `100000  ATIVO             1000  300   500   1200
...
3				  DESPESAS E CUSTOS							219.398,02D		99.112,37					0			318.510,39D					
 ...
 3.1.2.03				           Consumo de Agua do Amazonas							50
Balancete Contábil									Pág.: 1 de 3
...
Balancete Analitico (Valores em Reais)                                                                                 Folha:  00001
------------------------------------------------------------------------------------------------------------------------------------
TESLA, INC.                       (0619)
...
function deletMenu(string){   
    string = string.replace(/^(?=\D{2,})([\s*?\D\d].*)/gim,'').trim()
    return string
}
