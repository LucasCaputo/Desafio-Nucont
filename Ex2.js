const regex = /([1-3].[1-3].[1-3].[0-9][0-9]|[1-3].[1-3].[1-3]|[1-3].[1-3]\s|[1-3]\s)(\D*(\D*\d*-\d)?)(\s*\d{0,3}.\d{0,3}.\d{0,3},\d{0,2}[DC]?)((\s*\d{0,3}.\d{0,3}.\d{0,3},\d{0,2}[DC]?)|\s*[0])((\s*\d{0,3}.\d{0,3}.\d{0,3},\d{0,2}[DC]?)|\s*[0])(\s*\d{0,3}.\d{0,3}.\d{0,3},\d{0,2}[DC]?)/g;
const str = `1				  ATIVO							1.120.807,67D		527.081,41					464.716,15			1.183.172,93D					
...
`;
let m;
let description,classifier,openingBalance,debit,credit,finalBalance
let array=[]
...
while ((m = regex.exec(str)) !== null) {
    ...
    m.forEach((match, groupIndex) => {
        ...
        groupIndex == 4? openingBalance = (match):0
        groupIndex == 6? credit = (match):0
        groupIndex == 8? debit = (match):0
        groupIndex == 9? finalBalance= (match):0  

        credit == undefined?credit =0:0
        debit ==undefined?debit=0:0
